...
public class quanLyHH_Controller implements Initializable {
    ...
    public void loadDataFromDatabase() {
        try {
            ...
            while (resultSet.next()) {
                products_Data.add(new HangHoa_Module(resultSet.getInt(1), resultSet.getString(2), resultSet.getString(3),resultSet.getString(4), resultSet.getDouble(5), resultSet.getDouble(6), resultSet.getDouble(7), resultSet.getDouble(8)));
            }
    ...
    public void setSuaHH_Button() throws IOException {
        ...
        HangHoa_add_Controller hangHoaAddController = loader.getController();*/
        //hangHoaAddController.textList(maHang, tenHang, donViTinh, nhomSP, giaNhap, giaXuat, giaBanLe, tonKho);
        curentID = String.valueOf(maHang_Col.getCellData(index));
